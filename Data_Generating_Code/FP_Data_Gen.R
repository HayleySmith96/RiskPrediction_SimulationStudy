...
############------------ SET THE SEED ------------############
set.seed(12345)
# True model fit is sank to ../Results/true_models/FP_true_model.txt
# True predictions are saved to ../Results/true_models/FP_true_predictions.txt 
...
simulate_r_fp(real_data, nobs, r, admin_cens)
